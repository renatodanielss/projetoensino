...
public class ProfessorController {
	...
	public void cadastrar() throws IOException, ParseException
	{
		...
		if (mensagem.length() == 0){
			if (professorDao.inserir(this.newProfessor)){
				...
				//validar - importante adicionar o redirect com o par�metro origin=nome da entidade (letras min�sculas, sem espa�os oou caracteres especiais, por exemplo:
	...
	//validar - m�todo para valida��o de atributos do objeto associado � view, este m�todo ser� chamado pelo m�todo cadastrar e alterar
